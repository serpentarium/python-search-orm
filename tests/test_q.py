...
q6 = ('field1', Condition.RANGE, Range(fr=17, fr_incl=True),
      Q.DEFAULT_OPERATOR, False, (), 1)
q7 = ('field1', Condition.EQ, 1488, Q.DEFAULT_OPERATOR, True, (), 1)

q8 = (None, Condition.RANGE, Range(fr=17, fr_incl=True),
      Q.DEFAULT_OPERATOR, False, (), 1)
...
class TestQ(unittest.TestCase):
    ...
    def test_010_create(t):
        ...
        t.assertEqual(q2, Q(field1__lt=999), msg="Can no create Q from kwargs")
        t.assertEqual(q1, Q('field2'), msg="Can not create field-only Q")
        t.assertEqual(q1, Q(*q1), msg="Can not create Q from tuple")
        t.assertEqual(q1, Q(**make_kw(q1)), msg="Can not create Q from kwargs")
    ...
    def test_020_create_aggregation(t):
        ...
        t.assertEqual(
            [q for q in Q(query1, query2, query3).childs],
